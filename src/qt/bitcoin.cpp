 ...
 * The GreenShilling Developers 2017
 */
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. GreenShilling can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 7 && strncasecmp(argv[i], "GreenShilling:", 7) == 0)
        {
    ...
    app.setOrganizationName("GreenShilling");
    app.setOrganizationDomain("GreenShilling.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("GreenShilling-Qt-testnet");
    else
        app.setApplicationName("GreenShilling-Qt");
