...
static const int COINBASE_MATURITY_GSL = 30; // 100
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 20 * 30; // 10-minute block spacing
...
static const uint256 hashGenesisBlockOfficial("0x0000089d37687bff9b3b063bf0a9a37bba54b854ac49037eb0de32e938f54c29");
...
public:
    ...
    {
        // GreenShilling: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // GreenShilling: get transaction coin age
...
public:
    ...
    // GreenShilling: block signature - signed by coin base txout[0]'s owner
    ...
    // GreenShilling: two types of block: proof-of-work or proof-of-stake
    ...
    // GreenShilling: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // GreenShilling: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // GreenShilling: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // GreenShilling: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // GreenShilling: block index flags
    enum
    {
